...
public class PaypalPaymentService
    ...
    public ThirdPartyTransaction cancelPayment(final String paymentId) {
        ThirdPartyTransaction lastThirdPartyTransaction =
            repository.findFirstByPaymentIdOrderByIdDesc(paymentId)
    ...
    public PayoutBatch getPayoutResponse(final String payoutBatchId) {
        log.info("Get payout info");
        ...
        try {
            ...
            return payoutBatchRes.result();
        } catch (IOException e) {
            e.printStackTrace();

            throw new ValidatorException("Unsuccessfully get payout info", "paypal");
        }
    }
